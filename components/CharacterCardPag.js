    ...
    return (
        <View style={CharacterCardPagStyle.container}>
            <View style={CharacterCardPagStyle.buttonContainer}>
                {gotoPrevPage && <TouchableOpacity
                    style={CharacterCardPagStyle.button}
                    onPress={gotoPrevPage}
                >
                    <Text style={CharacterCardPagStyle.buttonText}>
                        {strings.TEXT_PREVIOUS}
                    </Text>
                </TouchableOpacity>}
            </View>
            <View style={CharacterCardPagStyle.buttonContainer}>
                {gotoNextPage && <TouchableOpacity
                    style={CharacterCardPagStyle.button}
