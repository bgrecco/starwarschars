...
const FavoriteFilterButton = ({listFavorites}) => {
    ...
    return (
        <View style={FavoriteFilterButtonStyle.container}>
            <TouchableOpacity
                style={[FavoriteFilterButtonStyle.button, pressed ? FavoriteFilterButtonStyle.buttonOn : FavoriteFilterButtonStyle.buttonOff]}
                onPress={onPressHandler}
            >
                <Text style={[FavoriteFilterButtonStyle.buttonText, pressed ? FavoriteFilterButtonStyle.buttonTextOn : FavoriteFilterButtonStyle.buttonTextOff]}>
