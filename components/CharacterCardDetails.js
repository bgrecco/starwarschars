...
const CharacterCardDetails = ({route, navigation}) => {
  ...
  return (
    <View style={CharacterCardDetailsStyle.returnContainer}>
      <Text style={CharacterCardDetailsStyle.returnText} onPress={onPressReturn}>
        {strings.TEXT_GOBACKTOLIST}
      </Text>
        ...
        <View style={CharacterCardDetailsStyle.infoContainer}>
          <View style={CharacterCardDetailsStyle.cardHeader}>
            ...
            <TouchableOpacity onPress={() => onPressFavorite()}>
              {favorite ? (
                <Icon
                  style={CharacterCardDetailsStyle.cardIcon}
                  name="star"
                  size={theme.ICON_SIZE_SMALL}
                  color={theme.ICON_STAR_COLOR}
                />
              ) : (
                <Icon
                  style={CharacterCardDetailsStyle.cardIcon}
          ...
          <Text style={CharacterCardDetailsStyle.cardDetailsText}>
            {strings.TEXT_BIRTHDATE}
          ...
          <Text style={CharacterCardDetailsStyle.cardDetailsText}>
            {strings.TEXT_HEIGHT}
            {character.height} | {strings.TEXT_MASS}
            {character.mass}
          </Text>
        </View>
      </View>
